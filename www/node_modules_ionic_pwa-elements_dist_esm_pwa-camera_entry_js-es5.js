        ...
        ImageCapture = /*#__PURE__*/function () {
          ...
          function ImageCapture(videoStreamTrack) {
            ...
            this.videoElementPlaying = new Promise(function (resolve) {
              _this10.videoElement.addEventListener('playing', resolve);
            });
      ...
      var CameraPWA = /*#__PURE__*/function () {
        function CameraPWA(hostRef) {
          ...
          this.handleClose = function (_e) {
            _this11.handlePhoto && _this11.handlePhoto(null);
          };
          ...
          this.handleCancelPhoto = function (_e) {
            var track = _this11.stream && _this11.stream.getTracks()[0];

            var c = track && track.getConstraints();
            _this11.photo = null;
            _this11.photoSrc = null;
          ...
          this.handleAcceptPhoto = function (_e) {
            _this11.handlePhoto && _this11.handlePhoto(_this11.photo);
          };

          this.handleFileInputChange = /*#__PURE__*/function () {
            var _ref = (0, _Users_vietle_sf_ionic_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
        ...
        _createClass(CameraPWA, [{
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 2:
                      ...
                      _context2.next = 5;
                      return _this2.queryDevices();

                    case 5:
                      _context2.next = 7;
                      return _this2.initCamera();
                ...
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    ...
                    case 9:
                      ...
                      _this3.deviceError = _context3.t0;
          ...
          key: "initCamera",
          value: function initCamera(constraints) {
            var _this4 = this;
                ...
                while (1) {
                  switch (_context4.prev = _context4.next) {
                    ...
                    case 8:
                      ...
                      _this4.deviceError = _context4.t0;
                      _this4.handleNoDeviceError && _this4.handleNoDeviceError(_context4.t0);
          ...
          key: "initStream",
          value: function initStream(stream) {
            var _this5 = this;
                ...
                while (1) {
                  switch (_context5.prev = _context5.next) {
                    case 0:
                      ...
                      _context5.next = 6;
                      return _this5.initPhotoCapabilities(_this5.imageCapture);
          ...
          value: function initPhotoCapabilities(imageCapture) {
            var _this6 = this;
                  ...
                  switch (_context6.prev = _context6.next) {
                    ...
                    case 2:
                      ...
                      if (c.fillLightMode && c.fillLightMode.length > 1) {
                        _this6.flashModes = c.fillLightMode.map(function (m) {
                          return m;
          ...
          key: "promptAccept",
          value: function promptAccept(photo) {
            var _this8 = this;
                ...
                while (1) {
                  switch (_context8.prev = _context8.next) {
                    case 0:
                      _this8.photo = photo;
                      _context8.next = 3;
                      return _this8.getOrientation(photo);
          ...
          value: function render() {
            ...
            return (0, _core_f86805ad_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
              ...
              "class": "item flash",
              onClick: function onClick(e) {
                return _this12.handleFlashClick(e);
              }
              ...
              ref: function ref(el) {
                return _this12.videoElement = el;
              },
              ...
              ref: function ref(el) {
                return _this12.canvasElement = el;
              },
              width: "100%",
              height: "100%"
            }), (0, _core_f86805ad_js__WEBPACK_IMPORTED_MODULE_1__.h)("canvas", {
              ...
              ref: function ref(e) {
                return _this12.offscreenCanvas = e;
              },
              width: "100%",
              height: "100%"
              ...
              onClick: function onClick(e) {
                return _this12.handleCancelPhoto(e);
              }
            }, (0, _core_f86805ad_js__WEBPACK_IMPORTED_MODULE_1__.h)("img", {
              src: this.iconRetake()
            })), (0, _core_f86805ad_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
              ...
              onClick: function onClick(e) {
                return _this12.handleAcceptPhoto(e);
              }
            }, (0, _core_f86805ad_js__WEBPACK_IMPORTED_MODULE_1__.h)("img", {
