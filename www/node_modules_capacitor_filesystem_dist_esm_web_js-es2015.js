  ...
  readdir(options) {
    ...
    return (0,_Users_vietle_sf_ionic_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
      ...
      const files = yield Promise.all(entries.map( /*#__PURE__*/function () {
        var _ref = (0,_Users_vietle_sf_ionic_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (e) {
  ...
  _copy(options, doRename = false) {
    ...
    return (0,_Users_vietle_sf_ionic_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
      ...
      const updateTime = /*#__PURE__*/function () {
        var _ref2 = (0,_Users_vietle_sf_ionic_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (path, ctime, mtime) {
